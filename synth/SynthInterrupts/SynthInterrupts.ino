...
int t = 0;//time
 ...
 // NOTES //
///////////
float C_4 = (10000/(261.63/2));
float D_4 = (10000/(293.66/2));
float E_4 = (10000/(329.63/2));
float F_4 = (10000/(349.23/2));
float G_4 = (10000/(392.00/2));
float A_4 = (10000/(440.00/2));
float B_4 = (10000/(493.88/2));
float C_5 = (10000/(523.25/2));
